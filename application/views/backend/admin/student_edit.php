    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/students/edit/' . $user_id); ?>" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <?php foreach ($class->result_array() as $cl) : ?>
                                                        <optgroup label="<?php echo $cl['name']; ?>">
                                                            ...
                                                            foreach ($sub_class as $scl) : ?>
                                                                <option value="<?php echo $scl['id_kelas']; ?>" <?php if ($scl['id_kelas'] == $students['kelas_id']) echo 'selected'; ?>><?php echo $scl['name']; ?></option>
                                                            <?php endforeach; ?>
                                                        </optgroup>
                                                    <?php endforeach; ?>
                                                </select>

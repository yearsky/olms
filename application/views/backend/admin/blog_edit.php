...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('edit_blog'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('blog_edit'); ?>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('admin/blog/edit/' . $blog_details['id']); ?>" method="post" enctype="multipart/form-data">
                            <div id="basicwizard">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_title" value="<?= $blog_details['title'] ?>" name="title" placeholder="<?php echo get_phrase('enter_blog_title'); ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="description" id="description" class="form-control"><?= $blog_details['content']; ?></textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                            <div class="box" style="width: 250px;">
                                                                <div class="js--image-preview" style="background-image: url(<?php echo $this->crud_model->get_blog_url($blog_details['image']) ?>); background-color: #F5F5F5;"></div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control bootstrap-tag-input" id="meta_keywords" name="meta_keywords" value="<?= $blog_details['meta_keyword'] ?>" data-role="tagsinput" style="width: 100%;" />
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="meta_description" class="form-control"><?= $blog_details['meta_description']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->

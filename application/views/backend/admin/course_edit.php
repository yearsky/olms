                                                            ...
                                                            <?php foreach ($class->result_array() as $cl) : ?>
                                                                <optgroup label="<?php echo $cl['name']; ?>">
                                                                    ...
                                                                    foreach ($sub_class as $scl) : ?>
                                                                        <option value="<?php echo $scl['id_kelas']; ?>" <?php if ($scl['id_kelas'] == $course_details['sub_kelas_id']) echo 'selected'; ?>><?php echo $scl['name']; ?></option>
                                                                    <?php endforeach; ?>
                                                                </optgroup>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="teachers" id="teachers" required>
                                                            ...
                                                            <?php foreach ($teachers->result_array() as $teacher) : ?>
                                                                <option value="<?= $teacher['id'] ?>" <?php if ($teacher['id'] == $course_details['teachers_id']) echo 'selected'; ?>><?= $teacher['first_name'] . ' ' . $teacher['last_name']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>

        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('admin/courses'); ?>" method="get">
                    ...
                    <div class="col-xl-2">
                        <div class="form-group">
                            <label for="category_id"><?php echo get_phrase('Class'); ?></label>
                                ...
                                <?php foreach ($class->result_array() as $cl) : ?>
                                    <optgroup label="<?php echo $cl['name']; ?>">
                                        ...
                                        foreach ($sub_class as $scl) : ?>
                                            <option value="<?php echo $scl['id_kelas']; ?>" <?php if ($selected_class_id == $scl['id_kelas']) echo 'selected'; ?>><?php echo $scl['name']; ?></option>
                                        <?php endforeach; ?>
                                    </optgroup>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <table id="course-datatable" class="table table-striped dt-responsive nowrap" width="100%" data-page-length='25'>
                            ...
                            <tbody>
                                <?php foreach ($courses as $key => $course) :
                                    $instructor_details = $this->user_model->get_all_user($course['teachers_id'])->row_array();

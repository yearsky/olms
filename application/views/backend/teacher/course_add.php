                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" hidden class="form-control" id="teacher_id" name="teacher_id" value="<?php echo $this->session->userdata('user_id'); ?>" placeholder="<?php echo get_phrase('teacher_id'); ?>" required>
                                                    </div>
                                                </div>

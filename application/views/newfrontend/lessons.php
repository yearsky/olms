    ...
    <div class="row">
        <div class="col-lg-3" style="margin-top: 100px;">
            <div class="text-center" style="margin-top: 10px;">
                <a href="<?php echo site_url('home/course/' . slugify($course_details['title']) . '/' . $course_details['id']); ?>" class="btn btn-outline-primary"><i class="fas fa-step-backward"></i> Go Back Course Detail</a>
                ...
                foreach ($sections as $section) :
                    ...
                    <div class="card" style="margin:10px 0px;">
                        <div class="card-header" id="<?php echo 'heading-' . $section['id']; ?>">
                            ...
                            <h5 class="mb-0">
                                <button class="btn btn-link w-100 text-left" type="button" data-toggle="collapse" data-target="<?php echo '#collapse-' . $section['id']; ?>" aria-expanded="true" aria-controls="<?php echo 'collapse-' . $section['id']; ?>" style="text-decoration:none; color: #535a66; background: none; border: none; white-space: normal;">
        ...
        <?php if (isset($lesson_id)) : ?>
            <div class="col-lg-9" style="margin-top: 100px;" id="video_player_area">

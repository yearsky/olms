        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="course-header-wrap">
                    ...
                    <a href="<?php echo site_url('home/lesson/' . slugify($course_details['title']) . '/' . $course_details['id']); ?>" class="btn mt-3"><?php echo get_phrase('start_lesson'); ?></a>
...
<section class="course-content-area" style="background:white">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">

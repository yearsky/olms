...
<script src="<?php echo base_url() . 'assets/newfrontend/assets/vendor/aos/aos.js'; ?>"></script>
<script src="<?php echo base_url() . 'assets/newfrontend/assets/vendor/bootstrap/js/bootstrap.bundle.min.js'; ?>"></script>
...
<script src="<?php echo base_url() . 'assets/newfrontend/assets/js/purecounter.js'; ?>"></script>
